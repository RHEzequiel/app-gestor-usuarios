    ...
    <body class="min-h-screen bg-white">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50">
            ...
            <flux:dropdown position="top" align="end">
                <div class="cursor-pointer relative flex h-8 w-8 shrink-0 overflow-hidden rounded-lg">
                    @if(auth()->user()->photo_path)
                        <img src="{{ Storage::url(auth()->user()->photo_path) }}" alt="{{ auth()->user()->name }}" class="h-8 w-8 object-cover rounded-lg">
                    @else
